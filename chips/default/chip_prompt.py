...
from extensions.BrainHackingChip.hackingchip_classes import HackingchipPrompts
...
def gen_full_prompt(user_input, state, **kwargs): # modifies hackingchip and state
    # global last_prompt
    # global last_chip
